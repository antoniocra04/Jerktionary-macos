        ...
        Form {
            ...
            Section("Чат") {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    .lineLimit(1...4)
                    Text("Ctrl+Shift+S молча снимает весь экран: без звука, без курсора, окно не всплывает. Если поле заполнено — снимок уходит с этим вопросом сразу, иначе ждёт в поле ввода.")
                        .font(.caption2)
                        .foregroundStyle(.tertiary)
                }
            }
